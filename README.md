...
|:--:|
| *Figure 5. GBSA energy prediction. (a) Losses of the train and validation samples during training. (b) Correlation plots on the train, validation, and test samples, respectively. (c) Target and predicted GBSA energy distributions in the train, validation, and test samples, respectively.* |
...
|:--:|
| *Figure 6. Logarithm of dissociation constant prediction. (a) Losses of the train and validation samples during training. (b) Correlation plots on the train, validation, and test samples, respectively. (c) Target and predicted logarithm of dissociation constant distributions in the train, validation, and test samples, respectively.* |
